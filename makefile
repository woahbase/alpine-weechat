...
# runtime flags
MOUNTFLAGS := \
	# -v $(CURDIR)/config:/home/alpine/.config \
	# -v $(CURDIR)/data:/home/alpine/.weechat \
	# -v $(CURDIR)/cache:/home/alpine/.cache \
...
OTHERFLAGS := \
	...
	-e PGID=$(PGID) \
	-e PUID=$(PUID) \
	# -e WEECHAT_HOME=/home/alpine/.weechat \
	# -e WEECHAT_PASSPHRASE=insecurebydefault \
	# -e TZ=Asia/Kolkata \
	#
